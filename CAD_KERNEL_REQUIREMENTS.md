...
| Snapping and dimensions | Accurate sketching and construction workflows need exact snapping and editable dimensions. | Sketch dimensions exist, and kernel query APIs expose evaluated curve endpoints, midpoints, parameters, tangents, curvature, B-spline spans, knots, control points, B-rep edge endpoints/frames/projection, surface UVN/knot/span/CV queries, closest-point surface projection, direction-based surface projection, and planar trimmed-face projection bounds. | Kernel queries for endpoints, midpoints, centers, tangencies, projected points, construction planes, distances, angles, and editable dimension constraints. | Add non-planar trim-aware projection and editable dimension constraint solving. |
