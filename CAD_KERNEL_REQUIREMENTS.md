...
| Snapping and dimensions | Accurate sketching and construction workflows need exact snapping and editable dimensions. | Sketch dimensions exist, and kernel query APIs expose evaluated curve endpoints, midpoints, parameters, tangents, curvature, B-spline spans, knots, control points, surface UVN/knot/span/CV queries, and closest-point surface projection. | Kernel queries for endpoints, midpoints, centers, tangencies, projected points, construction planes, distances, angles, and editable dimension constraints. | Add direction-based projection, edge projection queries, and editable dimension constraint solving. |
