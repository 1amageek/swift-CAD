...
|---|---|---|---|
| Subobject selection | Bodies, faces, edges, vertices, curve spans, surface spans, knots, and CVs need stable references. | Bodies, faces, edges, vertices, and generated persistent names exist for core features. | Extend references to trims, spans, knots, CVs, and generated curve/surface outputs. |
| Curve authoring | Lines, arcs, circles, Bezier, B-spline, rational NURBS, offsets, bridge curves, tangent snaps, and dimensions must share exact curve types. | Lines, circles, rational B-spline curves, sketch splines, curve continuity, and bridge curve output are available. | Add trim/span references, editable knots/CVs, exact offsets, and sketch constraints over generated curves. |
