...
| Snapping and dimensions | Accurate sketching and construction workflows need exact snapping and editable dimensions. | Sketch dimensions exist, and kernel query APIs expose evaluated curve endpoints, midpoints, parameters, tangents, curvature, B-spline spans, knots, control points, and surface UVN/knot/span/CV queries. | Kernel queries for endpoints, midpoints, centers, tangencies, projected points, construction planes, distances, angles, and editable dimension constraints. | Add edge/surface projection queries and editable dimension constraint solving. |
...
|---|---|---|---|
| Subobject selection | Bodies, faces, edges, vertices, curve spans, surface spans, knots, and CVs need stable references. | Bodies, faces, edges, vertices, generated persistent names, curve output references, curve span/knot/CV references, face surface span/knot/CV references, and evaluated curve tables exist for core feature outputs. | Extend references to trims, generated surface outputs, and topology-to-parameter projection references. |
