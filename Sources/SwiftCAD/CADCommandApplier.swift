...
public struct CADCommandApplier: Sendable {
    ...
    public func apply(
        ...
        case let .removeFeature(featureID):
            try remove(featureID, from: &updatedDocument)
        }
    ...
    private func remove(_ featureID: FeatureID, from document: inout CADDocument) throws {
