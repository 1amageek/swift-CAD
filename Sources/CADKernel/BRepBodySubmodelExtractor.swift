...
struct BRepBodySubmodelExtractor {
    func extract(bodyIDs: Set<BodyID>, from model: BRepModel) throws -> BRepModel {
            ...
            for shellID in body.shellIDs {
                ...
                for faceID in shell.faceIDs {
                    guard let face = model.faces[faceID],
                        ...
                        throw TopologyError.missingReference("Missing face geometry for \(faceID).")
                    }
                    ...
                    for loopID in face.loops {
                        ...
                        for orientedEdge in loop.edges {
                            ...
                            guard let edge = model.edges[edgeID],
                                ...
                                throw TopologyError.missingReference("Missing edge geometry for \(edgeID).")
                            }
