...
| General `supported` capabilities | 32 of the provisional 55 | All inventory-derived capabilities |
| `partial` capabilities | 23 | 0 |
...
The 32 currently `supported` catalog entries cover all seven geometry foundations,
...
Surface Extend, Surface Match, Face Loop Offset, Edge Offset, and Face Knife
...
topology inventory, the complete intersection matrix remains open, and 20
...
| Geometry | 7 | 7 | 0 | OPEN |
| Topology | 4 | 4 | 0 | OPEN |
| Modeling and constraints | 40 | 20 | 20 | OPEN |
