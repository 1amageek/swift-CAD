...
| General `supported` capabilities | 33 of the provisional 55 | All inventory-derived capabilities |
| `partial` capabilities | 22 | 0 |
...
The 33 currently `supported` catalog entries cover all seven geometry foundations,
...
Surface Extend, Surface Match, Face Loop Offset, Edge Offset, Face Knife, and Face Delete
...
topology inventory, the complete intersection matrix remains open, and 19
...
| Geometry | 7 | 7 | 0 | OPEN |
| Topology | 4 | 4 | 0 | OPEN |
| Modeling and constraints | 40 | 21 | 19 | OPEN |
