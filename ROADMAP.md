...
| General `supported` capabilities | 34 of the provisional 55 | All inventory-derived capabilities |
| `partial` capabilities | 21 | 0 |
...
The 34 currently `supported` catalog entries cover all seven geometry foundations,
...
topology inventory, the complete intersection matrix remains open, and 18
...
| Geometry | 7 | 7 | 0 | OPEN |
| Topology | 4 | 4 | 0 | OPEN |
| Modeling and constraints | 40 | 22 | 18 | OPEN |
