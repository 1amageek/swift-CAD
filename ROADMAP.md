...
| General `supported` capabilities | 31 of the provisional 55 | All inventory-derived capabilities |
| `partial` capabilities | 24 | 0 |
...
| Capability-to-fixture bindings | 480 | Complete adversarial and oracle coverage |
| Final gate evidence manifests | 0 | 8 on one source revision |
| Completion gates | 0/8 | 8/8 |

The 31 currently `supported` catalog entries cover all seven geometry foundations,
...
Surface Extend, and Surface Match contracts, the bounded exact Face Loop Offset
and Edge Offset contracts, and the shared strict Codable command/query/result
...
topology inventory, the complete intersection matrix remains open, and 21
...
| Geometry | 7 | 7 | 0 | OPEN |
| Topology | 4 | 4 | 0 | OPEN |
| Modeling and constraints | 40 | 19 | 21 | OPEN |
